...
function loadSavedTheme() {
    const savedTheme = localStorage.getItem("blogifyTheme");
...
function updateUserInfo() {
    ...
    if (token) {
        userInfo.textContent =
            "✨ You are logged in. Start sharing your story!";
    } else {
        userInfo.textContent =
    ...
    postForm.addEventListener("submit", async (event) => {
        ...
        try {
            ...
            if (postMessage) {
                ...
                postMessage.className = "success-message";
            }
            ...
            if (postMessage) {
                ...
                postMessage.className = "error-message";
            } else {
                alert(error.message);
            }
